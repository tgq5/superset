...
def get_commit_data(commit_hash):
    for commit in Repository(path_to_repo="repos_dir/superset", single=commit_hash).traverse_commits():
...
process_file("./json/superset_1.json")
